package mx.edu.potros.practicasql_bojorquezmichelle.data
...
class AlumnoSQLHelper(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTableAlumnos="CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, " +
                "$COLUMN_NAME TEXT, $COLUMN_FIRST_LASTNAME TEXT, $COLUMN_SECOND_LASTNAME TEXT, $COLUMN_EDU_PROGRAM TEXT )"
    ...
    fun insertAlumno(alumno: Alumno){
        ...
        val values= ContentValues().apply {
            ...
            put(COLUMN_FIRST_LASTNAME, alumno.paterno)
            put(COLUMN_SECOND_LASTNAME, alumno.materno)
